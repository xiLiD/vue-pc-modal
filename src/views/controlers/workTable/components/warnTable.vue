<template>
  <div class="table-content">
    <el-table :data="tableData" style="width: 100%;" height="172px" row-key="codeKey" :row-class-name="tableRowClassName" border>
      <el-table-column label="活动编码" prop="activeId" align="center" />
      <el-table-column label="活动名称" prop="activeName" align="center" />
      <el-table-column label="活动状态" prop="activeStat" align="center" />
