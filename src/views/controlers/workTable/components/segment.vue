<template>
  <div class="table-content">
    <el-table :data="tableData" style="width: 100%;" height="214px" row-key="codeKey" :row-class-name="tableRowClassName" border>
      <el-table-column label="客群编码" prop="tagId" align="center" />
      <el-table-column label="客群名称" prop="tagName" align="center" />
      <el-table-column label="客群规模" prop="userCnt" align="center" />
      <el-table-column label="被活动引用次数" prop="activeNum" align="center" />
      <el-table-column label="最佳活动接触数" prop="downCnt" align="center" />
      <!-- <el-table-column label="最佳活动接触率" prop="downRate" align="center" /> -->
      ...
      <el-table-column label="最佳活动办理率" align="center">
        <template slot-scope="scope">
